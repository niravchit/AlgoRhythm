...
//Data Model for the music library for our playlists

struct MusicLibrary {
    
    //An array of dictionaries containing playlist information
    //NOTE: For an actual playlist you won't HARDCODE DATA in!!
    //NOTE: Pull data of servers and build data models
